// ================================================================
// ADMINSEARCHORDERS.JSX – Pesquisa avançada de encomendas (admin)
// ================================================================
// Este componente permite ao administrador pesquisar e filtrar
// encomendas com critérios avançados:
// - Pesquisa textual (nome, email, produto, ID)
// - Filtro por estado (Comprado, Enviado, Recebido)
// - Filtro por intervalo de datas
// - Ordenação (ID, data, preço)
...
export default function AdminSearchOrders() {
  ...
  // ================================================================
  // FUNÇÃO: Buscar encomendas com filtros
  // ================================================================
  ...
  // Efeito: carrega encomendas sempre que os filtros mudarem
  useEffect(() => {
    fetchOrders();
  }, [fetchOrders]);
      ...
      <div style={{ display: 'flex', gap: 24, flexWrap: 'wrap' }}>
        ...
        <main style={{ flex: 1 }}>
          ...
          {!loading && orders.length === 0 && !error && (
            <p style={{ color: 'var(--muted)' }}>Nenhuma encomenda encontrada.</p>
          )}
              ...
              {orders.map(order => (
                ...
                >
                  ...
                  <div style={{ flex: 2, minWidth: '200px' }}>
                    {/* ID e data */}
                    <div>
                      <strong>#{order.order_id}</strong> – {new Date(order.data_compra).toLocaleString()}
                    </div>
                    {/* Utilizador */}
